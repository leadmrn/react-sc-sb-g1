...
export const Offline = () => 
  <Streamcard 
    ...
    picture={text("URL de l'image du stream", "https://static-cdn.jtvnw.net/previews-ttv/live_user_doigby-440x248.jpg")}
...
export const Online = () => <Streamcard name={text("Nom du streamer", "Sardoche")} title={text("Titre du stream", "Animal Crossing - Jour 1")} online={true} />;
